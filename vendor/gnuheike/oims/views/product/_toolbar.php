<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('oims','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'category - InvProductCategory', 'url' =>array('invProductCategory/admin')),array('label'=>'images - InvProductImage', 'url' =>array('invProductImage/admin')),
            )
          ),
        ),
    ));
